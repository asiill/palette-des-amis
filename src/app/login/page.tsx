      ...
      <div className="flex flex-col md:flex-row-reverse items-center gap-8 w-full max-w-4xl bg-[rgb(255 255 255 / 0%)] p-8 rounded-lg shadow-2xl mb-[70px]">
        ...
        <div className="w-full md:w-1/2">
          ...
          <form>
            ...
            <button formAction={login} className="w-full h-10 bg-teal-500 text-white text-sm font-semibold uppercase rounded-full hover:bg-teal-600 transition duration-300 ease-in-out">
              Login
            </button>
          </form>
        </div>
